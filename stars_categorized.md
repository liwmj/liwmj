...
- **[seajs/seajs](https://github.com/seajs/seajs)** `JavaScript` ⭐8266 — A Module Loader for the Web
...
- **[appium/appium-desktop](https://github.com/appium/appium-desktop)** `JavaScript` ⭐4816 — Appium Server in Desktop GUIs for Mac, Windows, and Linux  
  `appium`
- **[l0o0/translators_CN](https://github.com/l0o0/translators_CN)** `JavaScript` ⭐4698 — Zotero translator中文网页抓取翻译器🎉This is Zotero translators for Chinese Sites(beta), not the official Zotero repo  
...
- **[ganlvtech/down_52pojie_cn](https://github.com/ganlvtech/down_52pojie_cn)** `PHP` ⭐2794 — A single page file explorer that can be hosted on static website. 吾爱破解论坛 爱盘 https://down.52pojie.cn/ 页面的源代码  
...
- **[jrsoftware/issrc](https://github.com/jrsoftware/issrc)** `Pascal` ⭐5502 — Inno Setup is an open-source installation builder for Windows applications by Jordan Russell and Martijn Laan. Since its  
...
- **[benoitc/gunicorn](https://github.com/benoitc/gunicorn)** `Python` ⭐10631 — gunicorn 'Green Unicorn' is a WSGI HTTP Server for UNIX, fast clients and sleepy applications.  
...
- **[grigorig/stcgal](https://github.com/grigorig/stcgal)** `Python` ⭐775 — Open Source STC MCU ISP flash tool  
...
- **[unitreerobotics/unifolm-vla](https://github.com/unitreerobotics/unifolm-vla)** `Python` ⭐524
...
- **[visualfc/liteide](https://github.com/visualfc/liteide)** `C++` ⭐7762 — LiteIDE is a simple, open source, cross-platform Go IDE.   
...
- **[moby/swarmkit](https://github.com/moby/swarmkit)** `Go` ⭐3630 — A toolkit for orchestrating distributed systems at any scale. It includes primitives for node discovery, raft-based cons
...
- **[elastic/logstash](https://github.com/elastic/logstash)** `Java` ⭐14907 — Logstash - transport and process your logs, events, or other data  
...
- **[apache/storm](https://github.com/apache/storm)** `Java` ⭐6692 — Apache Storm  
...
- **[querydsl/querydsl](https://github.com/querydsl/querydsl)** `Java` ⭐4969 — Unified Queries for Java
- **[mcxiaoke/android-volley](https://github.com/mcxiaoke/android-volley)** `Java` ⭐4261 — DEPRECATED
...
- **[google/glog](https://github.com/google/glog)** `C++` ⭐7368 — C++ implementation of the Google logging module
...
- **[knolleary/pubsubclient](https://github.com/knolleary/pubsubclient)** `C++` ⭐4012 — A client library for the Arduino Ethernet Shield that provides support for MQTT.
- **[openvswitch/ovs](https://github.com/openvswitch/ovs)** `C` ⭐3990 — Open vSwitch
- **[abumq/easyloggingpp](https://github.com/abumq/easyloggingpp)** `C++` ⭐3940 — C++ logging library. It is powerful, supports asynchronous low latency, extendable, light-weight, fast performing, threa  
...
- **[jakogut/tinyvm](https://github.com/jakogut/tinyvm)** `C` ⭐3325 — TinyVM is a small, fast, lightweight virtual machine written in pure ANSI C.  
  `c` `virtual-machine`
...
- **[lsalzman/enet](https://github.com/lsalzman/enet)** `C` ⭐3237 — ENet reliable UDP networking library 
...
- **[Tencent/UnLua](https://github.com/Tencent/UnLua)** `C++` ⭐2747 — A feature-rich, easy-learning and highly optimized Lua scripting plugin for UE.
...
- **[equalsraf/neovim-qt](https://github.com/equalsraf/neovim-qt)** `C++` ⭐1997 — Neovim client library and GUI, in Qt5.  
...
- **[adamdunkels/uip](https://github.com/adamdunkels/uip)** `C` ⭐1075 — The historical uIP sources
...
- **[lmk123/oh-my-wechat](https://github.com/lmk123/oh-my-wechat)** `Shell` ⭐2765 — 微信小助手的安装 / 更新工具。  
  `macos` `wechat`
...
- **[zmartzone/lua-resty-openidc](https://github.com/zmartzone/lua-resty-openidc)** `Lua` ⭐1068 — OpenID Connect Relying Party and OAuth 2.0 Resource Server implementation in Lua for NGINX / OpenResty  
...
- **[metartc/metaRTC](https://github.com/metartc/metaRTC)** `C` ⭐1136 — webrtc sdk for embedded / IoT / robotics devices  
...
- **[slick/slick](https://github.com/slick/slick)** `Scala` ⭐2664 — Slick (Scala Language Integrated Connection Kit) is a modern database query and access library for Scala  
  `database` `scala` `sql`
- **[ZLMediaKit/ZLToolKit](https://github.com/ZLMediaKit/ZLToolKit)** `C++` ⭐2193 — 一个基于C++11的轻量级网络框架，基于线程池技术可以实现大并发网络IO  
...
- **[leafo/lapis](https://github.com/leafo/lapis)** `MoonScript` ⭐3328 — A web framework for Lua and OpenResty written in MoonScript  
